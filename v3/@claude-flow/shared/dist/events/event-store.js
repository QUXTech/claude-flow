...
export class EventStore extends EventEmitter {
    ...
    /**
     * Replay events from a specific sequence number (global ordering)
     * Uses SQLite's implicit rowid for global event sequence
     */
    async *replay(fromSequence = 0) {
        this.ensureInitialized();
        // Use rowid as global sequence number for proper event stream replay
    ...
    async getStats() {
        ...
        aggStmt.free();
        // Timestamp range - must call step() before getAsObject()
        ...
        rangeStmt.free();
        // Snapshot count - must call step() before getAsObject()
