...
import { commands, getCommand, getCommandAsync, getCommandNames, hasCommand } from './commands/index.js';
        ...
        try {
            ...
            if (result.checked && result.updatesAvailable.length > 0) {
                ...
                if (nonAutoUpdates.length > 0) {
                    ...
                    this.output.writeln(this.output.dim(`Run 'claude-flow update check' for details`));
                }
            }
        }
        catch {
...
export { initializeIntelligence, recordStep, recordTrajectory, findSimilarPatterns, getIntelligenceStats, getSonaCoordinator, getReasoningBank, clearIntelligence, benchmarkAdaptation, } from './memory/intelligence.js';
