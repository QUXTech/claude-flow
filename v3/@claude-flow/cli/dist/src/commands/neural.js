...
const trainCommand = {
    ...
    action: async (ctx) => {
        ...
        try {
            ...
            const { initializeIntelligence, recordStep, recordTrajectory, getIntelligenceStats, benchmarkAdaptation } = await import('../memory/intelligence.js');
...
const patternsCommand = {
    ...
    action: async (ctx) => {
        ...
        try {
            const { initializeIntelligence, getIntelligenceStats, findSimilarPatterns, } = await import('../memory/intelligence.js');
            await initializeIntelligence();
            const stats = getIntelligenceStats();
            if (action === 'list') {
